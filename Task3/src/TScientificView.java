...
public class TScientificView extends TStdView
{
	...
	public TScientificView(ICalculator calculator, boolean isHistory)
	{
	...
	{
		_calculator.onNumber(value);
		
		super.onInputNumber(value);
	}
	...
	protected void onInputOperation(String op)
	{
		if (op.equals("fak"))
		{
			_historyDisplay.setText(_display.getText() + "! =");
			
			_calculator.onOperation("fak");
